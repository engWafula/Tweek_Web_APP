  ...
  return (
    <div className='col-span-7 max-h-screen overflow-scroll lg:col-span-5 border-x'>
        <div className='flex items-center justify-between'>
            ...
            <RefreshIcon onClick={handleRefresh} className='w-8 h-8 cursor-pointer text-twitter transition-all duration-500 ease-out hover:rotate-180 active:scale-125'/>
        </div>
        {/* tweet box */}
        <div>
